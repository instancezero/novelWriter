...
class _ViewPanelKeyWords(QTreeWidget):
    ...
    def addUpdateEntry(self, tag: str, name: str, iItem: IndexItem, hItem: IndexHeading) -> None:
        ...
        trItem.setText(self.C_SHORT, hItem.climax)
        trItem.setToolTip(self.C_SHORT, hItem.climax)
        trItem.setText(self.C_SHORT, hItem.complication)
        trItem.setToolTip(self.C_SHORT, hItem.complication)
        trItem.setText(self.C_SHORT, hItem.crisis)
        trItem.setToolTip(self.C_SHORT, hItem.crisis)
        trItem.setText(self.C_SHORT, hItem.duration)
        trItem.setToolTip(self.C_SHORT, hItem.duration)
        trItem.setText(self.C_SHORT, hItem.incite)
        trItem.setToolTip(self.C_SHORT, hItem.incite)
        trItem.setText(self.C_SHORT, hItem.polarity)
        trItem.setToolTip(self.C_SHORT, hItem.polarity)
        trItem.setText(self.C_SHORT, hItem.resolution)
        trItem.setToolTip(self.C_SHORT, hItem.resolution)
        trItem.setText(self.C_SHORT, hItem.shift)
        trItem.setToolTip(self.C_SHORT, hItem.shift)
        trItem.setText(self.C_SHORT, hItem.turning)
        trItem.setToolTip(self.C_SHORT, hItem.turning)
        trItem.setText(self.C_SHORT, hItem.when)
        trItem.setToolTip(self.C_SHORT, hItem.when)
